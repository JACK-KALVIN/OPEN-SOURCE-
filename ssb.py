...
##M1##
def randBuildvsskj():
    END = 'Dalvik/2.1.0 (Linux; U; Android 12; SM-G990U Build/SP1A.210812.016) [FBAN/FB4A;FBAV/375.1.0.28.111;FBPN/com.facebook.katana;FBLC/en_US;FBBV/382948769;FBCR/T-Mobile;FBMF/samsung;FBBD/samsung;FBDV/SM-G990U;FBSV/12;FBCA/arm64-v8a:null;FBDM/{density=3.0,width=1080,height=2097};FB_FW/1;FBRV/0;]'
    ua = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {random.choice(model2)} Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}) '+END
    return ua
...
\033[1;37m    ######      ######     ########  
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            ABDULLHA
\033[1;37m Facebook:            ABDULLHA
\033[1;37m Github  :            Abdullha-404
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100089818537734')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
...
def dump():
    ...
    try:
        ...
        login()
    try:
        print('Enter xylon ID Save Path\n')
